...
export default function AffiliationUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = affiliationRecord
      ? { ...initialValues, ...affiliationRecord }
      : initialValues;
    setCa(cleanValues.ca);
    setCode(cleanValues.code);
    setUtilisations(cleanValues.utilisations);
    setErrors({});
  };
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Affiliation, idProp)
        : affiliation;
