...
export default function BilanCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setActiveCustomer(initialValues.ActiveCustomer);
    setErrors({});
  };
  const validations = {
    ca: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Bilan(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "BilanCreateForm")}
      {...rest}
    >
      <TextField
        label="Ca"
