...
export default function Pbcount() {
    ...
    const onPressed = async(data) => {
        ...
        if(user.user.user.goodcount != null){
                newCount = parseInt(data.count) + user.user.user.pbcount
                console.log(user.user.user.pbcount)
                console.log(parseInt(data.count)+ "dodoodod")
